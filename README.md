...
- **AI Nutritionist Receipts (RAG System):** นำรายชื่อเมนูและท็อปปิ้งที่ลูกค้าสั่ง วิ่งไปจับคู่กับฐานข้อมูลดิบในคลังความรู้ร้านอาหาร แล้วส่งให้โมเดล `gemini-2.5-flash` เพื่อสร้างใบเสร็จ สรุปแคลอรี่ และสารอาหารหลัก (โปรตีน/คาร์บ/ไขมัน) ได้อย่างแม่นยำ ป้องกันการมโนข้อมูล (No Hallucination)
